...
<head>
    ...
    <title>Visualizar Contas a Pagar</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/">
                <i class="fas fa-money-bill-wave me-2"></i>Sistema de Indicadores - Contas a Pagar
            </a>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Contas Pagas</h5>
                        <div class="col-sm-8">
                            <form name="filterForm" id="filterForm" action="/visualizar-contasPagar" method="GET" class="d-flex justify-content gap-2">
                        ...
                        @if($contas->count() < 1)
                            <center><h4>Nenhuma conta a pagar cadastrada nessa competência</h4></center>
                        @endif
                            ...
                            <div class="col-md-4">
                                <div class="card h-100">
                                    <div class="card-body text-center">
                                        ...
                                        <small class="text-muted">Contas Pagas</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($contas as $conta)
                                        ...
                                        <td class="text-center">{{ $conta->fornecedor_nome }}</td>
